...
class IncomeOutgoingService
{
    ...
    public function calculateMonthlyIncomeOutgoing(int $depositId, string $yearMonth): array
    {
        ...
        // Get the balance at the start of the month (last balance before month starts)
        $startBalance = $this->getBalanceAtDate($depositId, $startGregorian);

        // Get the balance at the end of the month (last balance in the month)
        $endBalance = $this->getBalanceAtDate($depositId, $endGregorian);

        // Get all balance records for the month
        $monthlyBalances = $this->getMonthlyBalances($depositId, $startGregorian, $endGregorian);

        // Calculate income and outgoing
...
//        Log::info('Check if any balance exists', [
//            'count' => Balance::where('deposit_id', $depositId)->count()
//        ]);
//        Log::alert('new logs => : ' , [
//            '$start balance date: ' => $startGregorian
//        ]);
//        Log::info($startBalance);
//        Log::alert('$endBalance');
//        Log::info($endBalance);
//        Log::alert('$monthlyBalances');
//        Log::info($monthlyBalances);
//        Log::alert('$income');
//        Log::info($income);
//        Log::alert('$outgoing');
//        Log::info($outgoing);
