...
Route::group(['prefix' => 'organ', 'middleware' => ['is-organ']], function () {
    Route::post('/update-balances', [DepositController::class, 'updateBalancesForOrgan'])->middleware('can:' . OrganPermissionKey::DEPOSIT_EDIT);
    ...
    Route::group(['prefix' => 'bank', 'middleware' => ['can:' . OrganPermissionKey::ORGAN]], function () {
        ...
        Route::post('/{bank}/update-balances', [BankController::class, 'updateBalances'])->middleware('can:' . OrganPermissionKey::BANK_EDIT);
    });
    ...
    Route::group(['prefix' => 'deposit', 'middleware' => ['can:' . OrganPermissionKey::DEPOSIT]], function () {
        ...
        Route::post('/{deposit}/update-balance', [DepositController::class, 'updateBalance'])->middleware('can:' . OrganPermissionKey::DEPOSIT_EDIT);
    });
});
